...
const AI = () => {
  ...
  const [isQuerySubmitted, setIsQuerySubmitted] = useState(false); // New state variable
  ...
  const handleSubmit = async () => {
    setIsQuerySubmitted(true); // Set to true when query is submitted
    try {
      ...
      setIsQuerySubmitted(false); // Set back to false when response is received
    }
  };
  ...
  return (
    <div className="flex h-screen border-r -mt-24 pt-24">
      <div className="w-1/2 p-6 pt-4 bg-gray-100 shadow-lg">
        <div
          style={{ display: 'flex', flexDirection: 'column', height: '60%' }}
          className="overflow-auto"
        >
          <h1 className="text-2xl font-bold my-2 text-gray-800">Streams</h1>
          <select
          ...
          >
            ...
            <option
              value="0x7277c78c02a4192ef8c48f5f4c529278d0e447fc/kyve/kyve-1/0"
              className="py-2 text-gray-900"
            >
              Cosmos Hub
            </option>
            <option
              value="0x7277c78c02a4192ef8c48f5f4c529278d0e447fc/kyve/kyve-1/1"
              className="py-2 text-gray-900"
            >
              Osmosis
            </option>
            <option
              value="0x7277c78c02a4192ef8c48f5f4c529278d0e447fc/kyve/kyve-1/2"
              className="py-2 text-gray-900"
            >
              Archway
            </option>
            <option
              value="0x7277c78c02a4192ef8c48f5f4c529278d0e447fc/kyve/kyve-1/3"
              className="py-2 text-gray-900"
            >
              Axelar
            </option>
      ...
      <div className="w-1/2 p-4">
        <h1 className="text-2xl font-bold my-2 text-gray-800">AI Query</h1>
      ...
      <div className="fixed right-0 bottom-0 m-4 p-2 bg-gray-100 text-black rounded border border-green-500">
        ...
        >
          <img
            src="https://cryptologos.cc/logos/streamr-data-logo.png"

...
function MyApp({ Component, pageProps }: AppProps) {
  return (
    ...
    <Head>
        ...
        />
        <meta name="keywords" content="Crypto queries blockchain data kyve network spaceid arbitrum sql nfts" />
        <link id="favicon" rel="icon" href="https://primodata.org/assets/img/database.svg"></link>
